...
(function($) {
    ...
    $.calendars.calendars.ummalqura.prototype.regionalOptions.ar = {
        ...
        epochs: ['BAM', 'AM'],
        monthNames: 'محرّم_صفر_ربيع الأول_ربيع الثاني_جمادى الأول_جمادى الآخر_رجب_شعبان_رمضان_شوّال_ذو القعدة_ذو الحجة'.split('_'),
        monthNamesShort: 'محرّم_صفر_ربيع1_ربيع2_جمادى1_جمادى2_رجب_شعبان_رمضان_شوّال_ذو القعدة_ذو الحجة'.split('_'),
