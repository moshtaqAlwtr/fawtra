...
<!-- المحتوى -->
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown mr-3">
                ...
                <div class="dropdown-menu" aria-labelledby="actionsDropdown" dir="rtl">
                    ...
                    <a class="dropdown-item" href="#"><i class="fas fa-file-pdf text-danger"></i> طباعة PDF</a>
                </div>
            </div>
    ...
    <div class="d-flex justify-content-between mt-4">
        ...
        <div class="dropdown-menu text-right" aria-labelledby="actionsMenu">
            <a class="dropdown-item" href="#">الصفحة الحالية</a>
            <a class="dropdown-item" href="#">كل الصفحات</a>
        </div>
    </div>
    ...
    <div class="form-section mt-4">
        ...
        <form class="form-row align-items-center">
            ...
            <div class="form-group col-md-4 mb-2">
                <input type="text" class="form-control" id="invoiceNumber" placeholder=".payment No">
            </div>
            
            <div class="form-group col-md-4 d-flex">
                
                <select class="form-control">
                    <option> اي عميل</option>
                </select>
            </div>
        </form>
                ...
                <div class="filter-section mt-3">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control">
                                <option>أي طرق دفع</option>
                                <option>نقدي</option>
                                <option>شيك</option>
                                <option>تحويل بنكي</option>
                                <option>بيتابس</option>
                                <option>الدفع عند الاستلام</option>
                                <option>رصيد العميل الاعتمادي</option>
                            </select>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control">
                                <option>أي مندوب</option>
                            </select>
                        </div>
                        
                        <div class="form-group col-md-3">
                            <label>تم التحصيل بواسطة</label>
                            <select class="form-control">
