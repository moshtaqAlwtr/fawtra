    ...
    return function k(p, m, d) {
        function r(f, n) {
            if (!m[f]) {
                ...
                p[f][0].call(c.exports, function(d) {
                    var c = p[f][1][d];
                    return r(c ? c : d)
                }, c, c.exports, k, p, m, d)
            }
        ...
        for (var t = "function" == typeof require &&
                require, n = 0; n < d.length; n++) r(d[n]);
        return r
    }({
        1: [function(k, p, m) {
            (function(d) {
                ...
                function n(b, a, c) {
                    ...
                    function l(a, e) {
                        if (!(a && u(d.document.documentElement, a) && u(d.document.documentElement,
                ...
                p.exports = function(b, a, h) {
                    ...
                    for (var g = 0; g < c.length; g++)
                        if (c[g].container === e && c[g]._debounce === k && c[g]._failsafe ===
                            a) return c[g].isInViewport(b, f, h);
                    return c[c.push(n(e, k, a)) - 1].isInViewport(b, f, h)
                };
                var c = [],
                    x = "function" === typeof d.MutationObserver,
                    u = function() {
                        return d.document ? d.document.documentElement.compareDocumentPosition ? function(b, a) {
                            return !!(b.compareDocumentPosition(a) & 16)
                        } : d.document.documentElement.contains ? function(b, a) {
