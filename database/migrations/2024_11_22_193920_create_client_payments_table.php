...
class CreateClientPaymentsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('client_payments', function (Blueprint $table) {
            $table->id('payment_id'); // معرف الدفع
            ...
            $table->unsignedBigInteger('journal_entry_id')->nullable(); // معرف القيد (يمكن أن يكون فارغًا)
            ...
            $table
            ->foreign('treasury_id')->references('treasury_id')->on('treasuries')->onDelete('cascade');
