...
class CreateExpensesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('expenses', function (Blueprint $table) {
            ...
            $table->string('created_by')->nullable(); // المستخدم الذي أنشأ المصروف
